                            ...
                            <form class="" action="<?php echo base_url('inventory/store_itemsReturned'); ?>" method="post" enctype="multipart/form-data" >
                                ...
                                <table class="mb-0 table table-hover" id="addProd">
                                    ...
                                    <tbody>
                                        <?php $i=1; foreach($items as $key) { ?>
                                            <tr>
                                                ...
                                                <?php  //{?>  
                                                <td >
                                                    <input type="text" style="<?php if($key['items_collected'] > $key['items_returned'] ){?> border-color: red;<?php } ?>" class="form-control" value="<?php echo $key['items_returned']?>" name="items_returned[]" required>
                                                </td>
                                                <?php //}?> 
                                                <td>
                                    ...
                                    <div class="row" hidden>
                                        ...
                                        <textarea class="form-control" name="comments" value="<?php echo $items[0]['comments']?>" rows="3"></textarea>
                                    </div>
